...
"""
Open the Package CSV File and read in the values
"""
with open('WGUTestDistance.csv') as csvfile:
    read_csv = csv.reader(csvfile, delimiter=',')

    hash_map = HashTable.HashMap()  # Create an instance of HashMap class
